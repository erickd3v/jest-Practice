...
class Film {
  constructor({
    ...
    // Id of the film
    if (idIMDB === "" || typeof idIMDB === "undefined")
      return { idIMDB: undef };
    ...
    if (director === "" || typeof director === "undefined")
      return { director: undef };
    ...
    if (
      ...
      return { countries: undef };
    for (const country of countries) {
      if (!regexCountry.test(country) || typeof country === "undefined")
        return valueError;
    }
    this.countries = countries;

    // Genero of the film
    if (genres.length === 0 || genres === "" || typeof genres === "undefined")
      return { genres: undef };
    ...
    if (calification === "" || typeof calification === "undefined")
      return { calification: undef };
    if (
      calification < 0 ||
      calification > 10 ||
      calification.toString().length > 3
    )
      return valueError;
